...
<Warning>
  Users on **iOS** or **Android** devices will be subject to pay extra due to
  the **App Store** or **Google Play** fees.
</Warning>
...
<AccordionGroup>
    ...
    <Accordion title="TikTok Notifications">
      Stream posts from a TikTok account to a text channel.
