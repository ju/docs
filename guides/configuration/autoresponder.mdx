...
<Tip>If on mobile, make sure to use `--` as such devices may automatically autocorrect it to `—`, which won't function.</Tip>
...
ㅤ
<Frame caption="Adding an embed autoresponder with the not_strict parameter" type="glass">
