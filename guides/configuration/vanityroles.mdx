...
---
## About
To utilise this feature, you need to invite Bleed's dedicated **Vanity Bot.** It is available to all users who have an active bleed subscription, and can be invited [here.](https://canary.discord.com/oauth2/authorize?client_id=996638412675227668&permissions=8&scope=bot%20applications.commands)

<Warning>
  If your server does not have level 3 boosts (14), the vanity bot will leave!
</Warning>
...
## FAQ
1. Why are there 2 seperate bots?
...
> No, it's available to all users who have Bleed and level 3 boosts.
...
> No, the vanity bot is slash commands only.
