---
title: 'Discogs'
description: 'Integrate bleed with [Discogs](https://www.discogs.com/).'
---
# Discogs Setup
To begin with Discogs, run `discogs login`. Bleed will then direct message you. Ensure direct messages are enabled otherwise this wont work!
