...
<Warning>
  Last.fm accounts that are marked as private will not be able to utilise some
  of Bleed's commands due to the bot not having access to the data.
</Warning>
...
![Last.fm Connection](/images/lflogin.png?raw=true)
...
![Latfm spotify connection](/images/spscrobble.png?raw=true)
...
![Ready to use lastfm module](/images/lfconfirm.png?raw=true)
