...
You can set a role that members will receive when they create a temporary voice channel.
This is useful if you want your `#interface` channel to only be visible to members inside a temporary voice channel.
...
<CodeGroup>
    ...
    ```javascript Example
    ,voicemaster default role @VoiceMaster
    ```
