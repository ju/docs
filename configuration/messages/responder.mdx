...
## Autoresponder Roles
Allow your members to assign or remove themselves roles by saying a specific message.
### What are Autoresponder Roles?
Autoresponder roles are roles that are assigned or removed to members when they say a specific message.

**Creating an autoresponder role**

You can create multiple autoresponder roles for a single trigger.
