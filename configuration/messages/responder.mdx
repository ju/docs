...
,autoresponder channel (channel) disallow (trigger)
```

```javascript Example
,autoresponder channel #welc allow welc
,autoresponder channel #jail disallow welc
```
...
,autoresponder role (role) disallow (trigger)
```

```javascript Example
,autoresponder role @staff allow welc
,autoresponder role @lame disallow welc
```
