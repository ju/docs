...
<AccordionGroup>
    <Accordion title="Threshold">
        ...
        <Info>It's recommended to keep the threshold between `1` and `6` to stay safe.</Info>
        <CodeGroup>
        ```javascript Syntax
        --threshold (number)
        ```
...
<AccordionGroup>
    <Accordion title="Punishing members for changing the vanity URL">
        ...
        <Warning>bleed can not change the vanity URL back to the original due to Discord limitations.</Warning>
        <CodeGroup>
        ```javascript Syntax
    ...
    <Accordion title="Preventing bots from being added">
        ...
        <br />
        <Frame>
        <img src="/images/security/antinuke/botadd.png" />
        </Frame>
    </Accordion>
    <Accordion title="Preventing members from being banned">
        ...
        <Info>It's recommended to include the `--command on` flag.</Info>
        <CodeGroup>
        ```javascript Syntax
        ...
        <br />
        <Frame>
        <img src="/images/security/antinuke/ban.png" />
        </Frame>
    ...
    <Accordion title="Preventing members from being kicked">
        ...
        <br />
        <Frame>
        <img src="/images/security/antinuke/kick.png" />
        </Frame>
    </Accordion>
    <Accordion title="Preventing roles from being deleted">
        ...
        <br />
        <Frame>
        <img src="/images/security/antinuke/role.png" />
        </Frame>
    </Accordion>
    <Accordion title="Preventing channels from being created or deleted">
        ...
        <br />
        <Frame>
        <img src="/images/security/antinuke/channel.png" />
        </Frame>
    </Accordion>
    <Accordion title="Preventing emojis from being deleted">
        ...
        <br />
        <Frame>
        <img src="/images/security/antinuke/emoji.png" />
        </Frame>
    </Accordion>
    <Accordion title="Preventing webhooks from being created">
        ...
        <br />
        <Frame>
        <img src="/images/security/antinuke/webhook.png" />
        </Frame>
...
<Frame>
  <img src="/images/security/antinuke/config.png" />
</Frame>
...
<Frame>
  <img src="/images/security/antinuke/list.png" />
</Frame>
...
<Frame>
  <img src="/images/security/antinuke/admins.png" />
</Frame>
