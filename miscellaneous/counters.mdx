...
Counters allows you to show important info in your server. This can be useful to show your members about signifcant milestones.
...
<Info>
  ...
  `staging_channels`, `boosts`, `booster_count` and `unix`.
</Info>
