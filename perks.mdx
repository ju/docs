...
| `,lastfm mode`| Edit the embed that shows the song you are listening to when running `,np`.
| `,lastfm customreactions` | Changes the reactions that appear under your `,np` embed. |
  </Tab>
