...
description: "Automatically announce new social media posts from your favorite creators."
icon: "bell"
---
...
<Card
  ...
  horizontal
>
  **TikTok** and **Instagram** require a [Subscription](/overview/donator-perks)
  to use, while the other social notification commands are available to all
  users without an additional subscription.
</Card>
...
<AccordionGroup>
    ...
    <Accordion title="Customizing the message">
        ...
        <Tip>
        This command is usually used to ping a role or user. In order for the message to actually notify the role or user, you must include the `--pingable only` flag in the command.
        </Tip>
        <CodeGroup>
...
<Card title="Twitter Spamming" icon="twitter" horizontal>
...
<Card title="YouTube Incorrect" icon="youtube" horizontal>
...
<Card title="Slight Delay in Notifications" icon="clock" horizontal>
...
<Card title="Customizing the Message" icon="message" horizontal>
