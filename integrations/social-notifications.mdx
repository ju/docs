...
<Card title="Subscription Required" icon="medal" iconType="duotone" horizontal>
  **TikTok**, **Instagram**, and **SoundCloud** require a [subscription](/overview/donator-perks)
...
<Card title="SoundCloud Problems" icon="soundcloud">
SoundCloud is in the **testing** phase for Tier 3. You may experience unexpected issues or problems. If you experience one of these flaws, please report it in our [Discord server](https://discord.gg/bleed).
